...
def main():
    ...
    def plot_reference_points(reference_points):
        ...
        plt.savefig(os.path.join('DATA_OUT', 'reference_points_nsga3_simple_200'))
    ...
    def plot_population(population):
        ...
        # plt.legend()
        # plt.show()
        plt.savefig(os.path.join('DATA_OUT', 'final_population_fitness_nsga3_dynamic_cm_200'))
    ...
    def plot_fitness_values_per_individual(fitness_values):
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(os.path.join('DATA_OUT', 'revisit_time_per_individuals_nsga3_dynamic_cm_200'))
        ...
        plt.grid(True)
        plt.tight_layout()
        plt.savefig(os.path.join('DATA_OUT', 'dwell_time_per_individuals_nsga3_dynamic_cm_200'))
    ...
    def dynamic_crossover_mutation(gen, ngen, Pc_start=0.9, Pm_start=0.05, Pm_end=0.4):
    ...
    def save_best_individuals(population, filename="best_individuals_nsga3_dynamic_cm_200.csv"):
    ...
    def run_ga_mu_plus_lambda_dynamic(initial_mu, lambda_, ngen, min_mu, decrease_rate):
        ...
        plt.savefig(os.path.join('DATA_OUT', 'pop_size_over_generation_nsga3_dynamic_cm_200'))
        ...
        # plt.legend()
        # plt.show()
        plt.savefig(os.path.join('DATA_OUT', 'pareto_front_nsga3_dynamic_cm_200'))
    ...
    run_ga_mu_plus_lambda_dynamic(initial_mu=200, lambda_=200, ngen=100, min_mu=40, decrease_rate=5)  # Example population of 20 and 10 generations lmbda_>= mu
